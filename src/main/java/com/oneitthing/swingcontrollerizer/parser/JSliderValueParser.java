...
/**
 * <p>[概 要] </p>
 * JSliderコンポーネントが保持する値を取得するクラスです。
 *
 * <p>[詳 細] </p>
 * JSliderコンポーネントの値を取得する為の
 ...
 */
public class JSliderValueParser implements Parser {
	 ...
	 *
	 * <p>[備 考] </p>
	 * JSliderコンポーネント値をパースするには
	 * {@link ComponentValueParser#parse(Component)}
	 * を使用して下さい。
	 */
	protected JSliderValueParser() {
	}
	 ...
	 * <p>[備 考] </p>
	 *
	 * @param slider 値をパースするJSliderコンポーネント
	 */
	public ComponentValues parse(Component slider) {
		ComponentValues ret = new ComponentValues();


		String name = ((JSlider)slider).getName();
		int value = ((JSlider)slider).getValue();
